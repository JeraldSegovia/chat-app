    ...
    <>
      {currentUserImage && (
        <div className='grid grid-flow-row overflow-hidden w-1/4 bg-gray-900 rounded-lg'>
          ...
          <div className="flex flex-col items-center overflow-auto space-x-3">
            {contacts.map((contact, index) => {
              return (
                <div
                  key={contact._id}
                  className={`h-15 cursor-pointer bg-green-500 rounded-lg mb-2 w-11/12 p-1 flex gap-3 items-center transition delay-75 ease-in-out ${
                    index === currentSelected ? "bg-green-900 rounded-lg" : ""
                  }`}
          ...
          <div className="bg-green-800 flex justify-center items-center gap-8 rounded-md p-1">
            <div>
              <img
